...
export default function CancelledOrderPage({ order }: { order: Order }) {
  return (
    <NavWrapper>
      <div className="flex flex-col gap-8 py-8 px-4 justify-between items-center min-h-screen">
        <header className="flex flex-col md:flex-row md:gap-4 items-center w-full">
          ...
          <p className="px-2 py-1 bg-red-500 text-white rounded text-sm font-medium">
            Annulée
          </p>
        </header>
        ...
        <main className="flex flex-col items-center gap-4 max-w-96">
          <p className="p-2 bg rounded text-justify">
            Cette commande s'est hara-kiri... elle a été annulée. Tu ne peux
            plus revenir en arrière, contacte un administrateur pour régler ton
            problème.
          </p>
        </main>
      </div>
